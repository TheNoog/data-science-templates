...
int main() {
    ...
    // Print the results
    std::cout << "Product A units to produce: " << glp_get_col_prim(lp, 1) << std::endl;
    std::cout << "Product B units to produce: " << glp_get_col_prim(lp, 2) << std::endl;
    std::cout << "Total Profit: $" << glp_get_obj_val(lp) << std::endl;
